...
export const getTopMoviesUrl = (page) => `https://netflixtrailers.herokuapp.com/Movies?api_key=${Keys.REACT_APP_MOVIEKEY}&language=en-US&page=${page}`
export const getTopRatedTvShowsUrl = (page) => `https://netflixtrailers.herokuapp.com/TVShows?api_key=${Keys.REACT_APP_MOVIEKEY}&language=en-US&page=${page}`
